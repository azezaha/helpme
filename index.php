        	...
        	<div class="container">
				...
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2 text">
						<h1 class="wow fadeInLeftBig">Iya</h1>
					...
					<div class="col-sm-6 col-sm-offset-3 r-form-1-box wow fadeInUp">
						<div class="r-form-1-top">
							<div class="r-form-1-top-left">
								<h3>Cek Ongkos Kirim Paket Anda</h3>
							</div>
						...
						<div class="r-form-1-bottom">
							<form role="form" action="" method="post">
								...
								<table>
									...
									<tr>
										<td> Berat (dalam gram) </td>
										<td><input type="number" class="input" name="weight"></td>
									</tr>
									
									<tr>
										<td> Pengemasan </td>
										<td><select name="packing">
											<option value="tidakada"> Tidak Ada</option>
											<option value="plastik"> Plastik</option>
											<option value="bubblewrap"> Bubble Wrap</option>
											<option value="kayu"> Kayu</option></td>
										</select>
									
									<tr>
										<td> Pengiriman </td>
										<td><input type="radio" name="pengiriman" value="a"> A</td>
									</tr>
									<tr>
										<td></td>
										<td><input type="radio" name="pengiriman" value="b"> B</td>
									</tr>
									<tr>
										<td></td>
										<td><input type="radio" name="pengiriman" value="c"> C</td>
									</tr>
	        ...
	        <div class="container">
	            ...
	            <div class="row">
                	<div class="col-sm-4 col-sm-offset-1 faq-box wow fadeInUp">
	                    ...
	                    <h3>What can I do with your app?</h3>
                    ...
                    <div class="col-sm-4 col-sm-offset-2 faq-box wow fadeInDown">
	                    ...
	                    <h3>Does it support multi-users?</h3>
	                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et.</p>
	                    <p>Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>
                    </div>
                </div>
	        ...
	        <div class="container">
	        	<div class="row">
	        		...
	        		<div class="col-sm-4 footer-contact-info wow fadeInDown">
	                	...
	                	<p><i class="fa fa-envelope"></i> Email: <a href="mailto:contact.azmind@gmail.com">contact.azmind@gmail.com</a></p>
	                	<p><i class="fa fa-skype"></i> Skype: regy_online</p>
                    </div>
